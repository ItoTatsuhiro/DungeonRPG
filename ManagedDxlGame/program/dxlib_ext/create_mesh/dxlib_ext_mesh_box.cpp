...
namespace dxe {
	...
	//----------------------------------------------------------------------------------------
	Shared<Mesh> Mesh::CreateBox(const float size, const int div_w, const int div_h, const float uv_adjusted, const bool is_left_cycle) noexcept
	{
		Shared<Mesh> mesh = Shared<Mesh>(new Mesh());
		mesh->desc_ = std::make_shared<MeshDescBox>(size, div_w, div_h, is_left_cycle);
	...
	Shared<Mesh> Mesh::CreateBoxMV(const float size, const int div_w, const int div_h, const float uv_adjusted, const bool is_left_cycle) noexcept {
		Shared<Mesh> mesh = CreateBox(size, div_w, div_h, uv_adjusted, is_left_cycle);
