...
namespace dxe {
	...
	public :
		...
		static Shared<Mesh> CreateBox(const float size, const int div_w = 5, const int div_h = 5, const float uv_adjusted = 0.005f, const bool is_left_cycle = false) noexcept;
		static Shared<Mesh> CreateBoxMV(const float size, const int div_w = 5, const int div_h = 5, const float uv_adjusted = 0.005f, const bool is_left_cycle = false) noexcept;
